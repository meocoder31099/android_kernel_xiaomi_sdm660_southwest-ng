...
static int __init i8042_pnp_init(void)
{
	...
	if (((i8042_pnp_data_reg & ~0xf) == (i8042_data_reg & ~0xf) &&
	    ...
	    !i8042_pnp_data_reg) {
		pr_debug("PNP: PS/2 controller has invalid data port %#x; using default %#x\n",
			i8042_pnp_data_reg, i8042_data_reg);
		i8042_pnp_data_reg = i8042_data_reg;
	...
	if (((i8042_pnp_command_reg & ~0xf) == (i8042_command_reg & ~0xf) &&
		...
		pr_debug("PNP: PS/2 controller has invalid command port %#x; using default %#x\n",
			i8042_pnp_command_reg, i8042_command_reg);
		i8042_pnp_command_reg = i8042_command_reg;
		pnp_data_busted = true;
	}
	...
	if (!i8042_nokbd && !i8042_pnp_kbd_irq) {
		pr_debug("PNP: PS/2 controller doesn't have KBD irq; using default %d\n",
			i8042_kbd_irq);
	...
	if (!i8042_noaux && !i8042_pnp_aux_irq) {
		if (!pnp_data_busted && i8042_pnp_kbd_irq) {
			pr_debug("PNP: PS/2 appears to have AUX port disabled, "
				"if this is incorrect please boot with i8042.nopnp\n");
			i8042_noaux = true;
		} else {
			pr_debug("PNP: PS/2 controller doesn't have AUX irq; using default %d\n",
				i8042_aux_irq);
