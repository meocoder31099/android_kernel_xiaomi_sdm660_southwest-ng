...
#define SDEROT_WARN(fmt, ...)	pr_debug("<SDEROT_WARN> " fmt, ##__VA_ARGS__)
#define SDEROT_ERR(fmt, ...)	pr_debug("<SDEROT_ERR> " fmt, ##__VA_ARGS__)
...
#define SDEDEV_WARN(dev, fmt, ...)	\
	dev_dbg(dev, "<SDEROT_WARN> " fmt, ##__VA_ARGS__)
#define SDEDEV_ERR(dev, fmt, ...)	\
	dev_dbg(dev, "<SDEROT_ERR> " fmt, ##__VA_ARGS__)
