 ...
 * (CFS  default: 10ms * (1 + ilog(ncpus)), units: nanoseconds)
 */
 ...
 * (CFS  default SCHED_TUNABLESCALING_LINEAR  = *(1+ilog(ncpus))
 */
#ifdef CONFIG_SCHED_BORE
 ...
 * (CFS  default: 0.5 msec * (1 + ilog(ncpus)), units: nanoseconds)
 */
#ifdef CONFIG_SCHED_BORE
 ...
 * (CFS  default: 5 msec * (1 + ilog(ncpus)), units: nanoseconds)
 */
#ifdef CONFIG_SCHED_BORE
